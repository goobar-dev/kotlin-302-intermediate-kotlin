...
fun main() {
    ...
    // throw IllegalStateException(message = "Oops", cause = Throwable())
    // throw IllegalStateException()

    // try-catch-finally block similar to Java's
    try {
        throw IllegalStateException()
...
//    }
    ...
    // In Java you're forced to declare whether you throw an exception, but not in Kotlin
...
// This is already provided in Arrow, Kotlin's de facto functional programming library.
// Comes with lots of helper methods as well

// getOrDefault(), filter(), orEmpty()
