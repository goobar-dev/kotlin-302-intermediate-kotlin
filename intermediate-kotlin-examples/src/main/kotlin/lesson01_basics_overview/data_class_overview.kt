...
// data classes are Kotlin's version of a POJO
// data classes automatically implement toString(), hashCode(), and equals()
...
// for all properties.
// This will allow for instantiation without needing to pass explicit values
...
// In this example, `numEyes` will not be taken into account when equality checks are performed
